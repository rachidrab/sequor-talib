...
@RestController
@RequestMapping("/api/sequor-talib-kafka")
public class SequorTalibKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SequorTalibKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SequorTalibKafkaResource(KafkaProperties kafkaProperties) {
